...
if($_SESSION['level']<1){
  header("location:../login.php?pesan=agen");
}
?>
<!-- partial -->
    ...
    <!-- <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Add Agen </a></li>
        </ul>
      </div>
    </li>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          ...
          <tbody>
            ...
            if(isset($_GET['searching'])){
              $cari = $_GET['searching'];
              $data = mysqli_query($koneksi, "select * from booking where kode_booking like '%".$cari."%' or nama like '%".$cari."%' order by tanggal DESC, konfirmasi ASC");       
            }else{
            ...
            while($d = mysqli_fetch_array($data)){
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-primary" href="konfirmasi.php?id=<?php echo $d['id']; ?>">KONFIRMASI</a>
                </td>
              </tr>
            <?php }  ?>
          </tbody>
